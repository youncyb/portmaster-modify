...
type (
	...
	ConnectionStore interface {
		...
		UpdateBandwidth(ctx context.Context, enableHistory bool, profileKey string, profileName string, processKey string, connID string, bytesReceived uint64, bytesSent uint64) error
